...
#ifndef __CLASE_ALOJAMIENTOS__
#define __CLASE_ALOJAMIENTOS__  
...
// Definir la clase Alojamientos dentro del namespace bblProg2
...
// -------- MÉTODOS PÚBLICOS DE LA CLASE Alojamientos
        ...
        //                          (en orden creciente).
        void alojamientosAnfitrion(unsigned id_anfitrion, Ids &ids_alojamientos) const;
        ...
        //                          del punto dado.
        void alojamientosAlrededor(double latitud, double longitud, double kms, Ids &ids_alojamientos) const;
        ...
        void alojamientosBarrio(const std::string &barrio, Ids &ids_alojamientos) const;
        ...
        void alojamientosTipo(const std::string &tipo_alojamiento, Ids &ids_alojamientos) const;
        ...
        //                          al precio dado
        void alojamientosPrecio(double precio, Ids &ids_alojamientos) const;
        ...
        //                          dado.
        void alojamientosNoches(unsigned num_noches, Ids &ids_alojamientos) const;
        ...
        void alojamientosFiltros(const std::string &barrio,
        ...
        void escribirEnFichero(const std::string &nombre_fichero, Resultado &res) const;
        ...
        //  - res (S): resultado de la operación
        void insertarAlojamiento(const Alojamiento &alojamiento, Resultado &res);
        ...
        //  - res (S): resultado de la operación
        void modificarAlojamiento(const Alojamiento &alojamiento, Resultado &res);
        ...
        //  - res (S): resultado de la operación
        void eliminarAlojamiento(unsigned id_alojamiento, Resultado &res);
        ...
        //  - nombre_fichero (E): nombre del fichero de datos de alojamientos
        //  - res (S): resultado de la operación.
        void leerAlojamientos(const std::string &nombre_fichero, Resultado &res);
...
// ------------------- PARTE PRIVADA DE LA CLASE Alojamientos
        ...
        void buscarAlojamiento(unsigned id_alojamiento, unsigned &posicion, bool &encontrado) const;
        ...
        void abrirHueco(unsigned posicion);
        ...
        // PRECONDICIÓN: posicion < num_alojamientos
        void cerrarHueco(unsigned posicion);
        };
}
#endif